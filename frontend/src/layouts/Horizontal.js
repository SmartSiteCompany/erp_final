          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                <i class="uil-flask me-2"></i> <div class="arrow-down"></div>
              </a>
              ...
              <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl" aria-labelledby="topnav-uielement">
                <div class="row">
                  <div class="col-lg-4">
                    <div>
                      <a href="/ui-alerts" class="dropdown-item"></a>
                      <a href="/ui-buttons" class="dropdown-item"></a>
                      <a href="/ui-cards" class="dropdown-item"></a>
                      <a href="/ui-carousel" class="dropdown-item"></a>
                      <a href="/ui-dropdowns" class="dropdown-item"></a>
                      <a href="/ui-grid" class="dropdown-item"></a>
                      <a href="/ui-images" class="dropdown-item"></a>
                      <a href="/ui-lightbox" class="dropdown-item"></a>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div>
                      <a href="/ui-modals" class="dropdown-item"></a>
                      <a href="/ui-offcanvas" class="dropdown-item"></a>
                      <a href="/ui-rangeslider" class="dropdown-item"></a>
                      <a href="/ui-session-timeout" class="dropdown-item"></a>
                      <a href="/ui-progressbars" class="dropdown-item"></a>
                      <a href="/ui-placeholders" class="dropdown-item"></a>
                      <a href="/ui-sweet-alert" class="dropdown-item"></a>
                      <a href="/ui-tabs-accordions" class="dropdown-item"></a>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div>
                      <a href="/ui-typography" class="dropdown-item"></a>
                      <a href="/ui-toasts" class="dropdown-item"></a>
                      <a href="/ui-video" class="dropdown-item"></a>
                      <a href="/ui-general" class="dropdown-item"></a>
                      <a href="/ui-colors" class="dropdown-item"></a>
                      <a href="/ui-rating" class="dropdown-item"></a>
                      <a href="/ui-notifications" class="dropdown-item"></a>
                    </div>
                  </div>
                </div>
