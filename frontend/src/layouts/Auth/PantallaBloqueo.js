...
const PantallaBloqueo = () => {
  ...
  const { user: authUser, unlockScreen } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    if (!userData?.email) {
      setError("No se puede verificar el usuario");
      return;
    }
            ...
            <div className="col-md-10 col-lg-6 col-xl-5">
              <div>
                <Link to="/" className="mb-5 d-block auth-logo">
                  <img src="/assets/images/logo-dark.png" alt="Logo" height="22" className="logo logo-dark" />
                  <img src="/assets/images/logo-light.png" alt="Logo" height="22" className="logo logo-light" />
                </Link>
                <div className="card">
                  <div className="card-body p-4">
                    <div className="text-center mt-2">
                      <h5 className="text-primary">Pantalla Bloqueada</h5>
                      <p className="text-muted">Ingrese su contraseña para continuar</p>
                    </div>
